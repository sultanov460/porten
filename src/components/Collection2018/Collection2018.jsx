...
export const Collection2018 = () => {
  return (
    <div className=" flex flex-col items-center bg-black text-white xl:flex-row md:py-3.5 md:gap-2.5 xl:py-0">
      <img
      ...
      <div className="px-3 py-4.5 mx-auto flex justify-center items-center gap-10 flex-col max-w-[1040px]">
        <h1 className="uppercase font-playfair text-4xl font-normal">
          коллекция 2018
        </h1>
        <div className="w-[120px] border border-white"></div>
        <p className="max-w-[471px] text-center font-ptsans leading-[1rem] text-sm md:max-w-[600px] md:leading-[1.5rem]">
